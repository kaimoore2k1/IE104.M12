<?php
    ...
    $sql = "SELECT * FROM phong where type=2";
    $kq = $conn->query($sql);
    $sql_ct = "SELECT * FROM ct_hotel where type=2";
...
<header>
        ...
        <p id="tag_domesticHotel">Grand Hotel Principe di Piemonte</p>
        <p id="tag_domesticHotel--ipad">Grand Hotel Principe di Piemonte</p>
        <img id="logo_header" src="File/grand.svg" alt="Header_picture_Home">
    </header>
    <main>
        <h1>Grand Hotel Principe di Piemonte</h1>
        <div id="content-down">
            <img src="File/star.svg" alt="Đánh giá">
            <p id="hotel__content--point"><b style="color: black;">5.0</b></p>
            <p>Tuyệt vời <span style="color: black;">| 142 đánh giá</span></p>
        </div>
        <img id="hotel__content--location-logo" src="File/location.svg" alt="location">
        <p id="hotel__content--location">Piazza Puccini 1,, Italy</p>
        <div class="grid-container">
            <img id="item1" src="File/fusion1 copy.png" alt="Fusion_PhuQuoc">
            <img id="item2" src="File/fusion2 copy.png" alt="Fusion_PhuQuoc">
            <img id="item3" src="File/fusion3 copy.png" alt="Fusion_PhuQuoc">
            <img id="item4" src="File/fusion4 copy.png" alt="Fusion_PhuQuoc">
            <img id="item5" src="File/fusion5 copy.png" alt="Fusion_PhuQuoc">
        </div>
