<?php
    ...
    $kq = $conn->query($sql);
    $sql_price = "SELECT * FROM hotel where type = 2 order by Price" ;
    $kq_price = $conn->query($sql_price);
    $sql_voting = "SELECT * FROM hotel where type = 2 order by Price desc" ;
...
<head>
    ...
    <script src="../KhachsanTrongnuoc/ks_tn.js" defer></script>
...
<body>
    ...
    <h1 id="tag_favorite">Điểm đến yêu thích nước ngoài</h1>
        ...
        <div class="grid-container">
            <div id="item1">
                <a href="#">
                    <p><b>Portugal</b><br><span>224 khách sạn</span></p>
                    <img src="File/potugal.png" alt="Portugal">
                </a>
            </div>
            <div id="item2">
                <a href="#">
                    <p><b>Switzerland</b><br><span>272 khách sạn</span></p>
                    <img src="File/Switzerland.png" alt="Switzerland">
                </a>
            </div>
            <div id="item3">
                <a href="#">
                    <p><b>Spain</b><br><span>316 khách sạn</span></p>
                    <img src="File/Spain.png" alt="Spain">
                </a>
            </div>
            <div id="item4">
        ...
        <h1 id="tag_hotel">Khách sạn nước ngoài</h1>
